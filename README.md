...
Communication -> [Stoat](https://stoat.chat) / [Signal](https://signal.org) / [SimpleX](https://github.com/simplex-chat/simplex-chat) / [Jitsi Meet](https://jitsi.org) / [Element](https://element.io)
